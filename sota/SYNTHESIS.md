...
Generated 2026-09-23 from the claim ledger.
...
| Architecture (`ARCH`) | 21 | yes |
| Photonics (`PHOT`) | 24 | yes |
| EDA (`EDA`) | 4 | yes |
| Economics (`ECON`) | 0 | **nothing yet** |

6 of 10 layers have any claim at all. 28 source record(s) read; 516 candidate(s) queued unread.
...
- 516 candidate(s) sit unread. Until they are read, absence of a claim here is absence of reading, not absence of evidence.
