...
| `CLM-PHOT-0009` = 0.0017 um | `CLM-PHOT-0026` = 0.85 um | 100% | roughness_type=arithmetic average roughness (Sa) | component=MO-PhC slab |
| `CLM-PHOT-0010` = 0.0021 um | `CLM-PHOT-0026` = 0.85 um | 100% | roughness_type=root mean square roughness (Sq) | component=MO-PhC slab |
...
| `CLM-ARCH-0019` = 8.4e+04 ns | `CLM-PHOT-0025` = 4e+06 ns | 98% | concurrency_n_a=48, memory_tier=HBF | illumination=random speckle illumination |
...
| `CLM-ARCH-0020` = 1.4e+07 ns | `CLM-PHOT-0025` = 4e+06 ns | 71% | concurrency_n_a=48, design=our design with tiering | illumination=random speckle illumination |
